getMediaApp.controller('shoppingCart_controller', ['$scope', '$location', function ($scope, $location) {
    // -------------------
    // shopping cart array
    // -------------------
    ...
    $scope.theEnvelope = false;
    $scope.showEnvelope = function (value) {
		$scope.theEnvelope = value;
	};

	$scope.contactConfirm = false;
    
    $scope.showConfirm = function (value) {
		$scope.contactConfirm = value;
	};
